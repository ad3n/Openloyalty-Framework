...
class SettingsFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add($builder->create(
            self::ALLOW_CUSTOMERS_PROFILE_EDITS_SETTINGS_KEY,
            SettingsCheckboxType::class,
            [
            'required' => false,
        ]
        ));
        ...
        $builder->add(
            $builder
                ->create(
                    self::TIER_ASSIGN_TYPE_SETTINGS_KEY,
                    SettingsChoicesType::class,
                    [
                    'choices' => [
        ...
        $builder->add(
            $builder->create(
                self::LEVEL_DOWNGRADE_MODE_SETTINGS_KEY,
                SettingsChoicesType::class,
                [
                'choices' => [
        ...
        $builder->add(
            $builder->create(
                self::LEVEL_DOWNGRADE_BASE_SETTINGS_KEY,
                SettingsChoicesType::class,
                [
                'choices' => [
        ...
        $builder->add(
            $builder->create(
                self::LEVEL_RESET_POINTS_ON_DOWNGRADE_SETTINGS_KEY,
                SettingsCheckboxType::class,
                [
                'required' => false,
            ]
